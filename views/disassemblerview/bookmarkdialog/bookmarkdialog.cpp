...
BookmarkDialog::BookmarkDialog(DisassemblerDefinition *disassembler, QWidget *parent): QDialog(parent), ui(new Ui::BookmarkDialog), _bookmarklist(disassembler->listing()->bookmarks()), _selectedblock(nullptr)
{
    ui->setupUi(this);
