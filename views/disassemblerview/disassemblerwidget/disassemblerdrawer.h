#ifndef DISASSEMBLERDRAWER_H
#define DISASSEMBLERDRAWER_H
...
class DisassemblerDrawer: public QObject
{
    Q_OBJECT

    public:
        explicit DisassemblerDrawer(QHexEditData* hexeditdata, QPainter& painter, QFontMetrics& fontmetrics, int &charwidth, int& charheight, int& y, QObject* parent = 0);
