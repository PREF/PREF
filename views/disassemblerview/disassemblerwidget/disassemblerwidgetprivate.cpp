...
DisassemblerWidgetPrivate::DisassemblerWidgetPrivate(QScrollArea* scrollarea, QScrollBar* vscrollbar, QWidget *parent): QWidget(parent), _hexeditdata(nullptr)
{
...
void DisassemblerWidgetPrivate::setInstructionCount(quint64 instructioncount)
{
    this->_instructioncount = instructioncount;
}

void DisassemblerWidgetPrivate::setData(QHexEditData *hexeditdata)
{
...
void DisassemblerWidgetPrivate::gotoVA(quint64 va)
{
...
void DisassemblerWidgetPrivate::gotoEP()
{
    /*
    if(this->_model && this->_model->itemCount())
    {
...
qint64 DisassemblerWidgetPrivate::verticalSliderPosition64()
{
    return static_cast<qint64>(this->_vscrollbar->sliderPosition());
}

bool DisassemblerWidgetPrivate::drawLine(DisassemblerDrawer* drawer, lua_Integer i)
{
    bool b = false;
...
void DisassemblerWidgetPrivate::vScrollBarValueChanged(int)
{
    this->update();
}

void DisassemblerWidgetPrivate::paintEvent(QPaintEvent *e)
{
    ...
    if(this->_hexeditdata)
    {
        ...
        DisassemblerDrawer dd(this->_hexeditdata, painter, fm, this->_charwidth, this->_charheight, y);
...
void DisassemblerWidgetPrivate::mousePressEvent(QMouseEvent *)
{
...
void DisassemblerWidgetPrivate::wheelEvent(QWheelEvent *event)
{
    if(this->_hexeditdata && this->_instructioncount)
    {
